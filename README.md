...
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-rename-tag">Auto Rename Tag</a><br />
Automatically rename paired HTML/XML tag.<br /><br />
<img alt="auto-rename-tag" src="auto-rename-tag.png" style="width: 80%;" />

<br />
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=CoenraadS.bracket-pair-colorizer">Bracket Pair Colorizer</a><br />
...
<img alt="bracket-pair-colorizer" src="bracket-pair-colorizer.png" style="width: 80%;" />

<br /><br />
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=naumovs.color-highlight">Color Highlight</a><br />
Highlight web colors in your editor.<br /><br />
<img alt="color-highlight" src="color-highlight.png" style="width: 80%;" />

<br />
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=WallabyJs.quokka-vscode">Quokka.js</a><br />
...
<br /><br />
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=sburg.vscode-javascript-booster">JavaScript Booster</a><br />
Provides various code actions (quick fixes) when editing code in JavaScript (or TypeScript/Flow).<br /><br />
<img alt="javaScript-booster" src="javaScript-booster.png" style="width: 80%;" />

<br /><br />
✍️ <a style="color: #AF2167; font-size: 22px;" href="https://marketplace.visualstudio.com/items?itemName=mrmlnc.vscode-scss">SCSS IntelliSense</a><br />
